...
const products = [
  ...
  { id: 51, title: ' Broca esacalonada de titanio 4 -20mm  ', price: 4800, img: 'img/broca.jpg', category: 'herramientas', description: 'Broca escalonada de titanio, ideal para perforar materiales de diferentes grosores.' },
  { id: 52, title: ' Discos flap blister x 10 unidades (Sin stock ) ', price: 8500, img: 'img/discosflap.jpg', category: 'herramientas', description: 'Discos flap, ideales para lijar y pulir superficies de metal y madera.' },
  
  { id: 53, title: ' Lubricante multiuso 330 cm 3 ', price: 5500, img: 'img/lubricante.jpg', category: 'herramientas', description: 'Lubricante multiuso, ideal para evitar el oxido , lubrica y destraba .' },
  { id: 54, title: ' Kit taladro mas amoladora de alta potencia inhalambrica ', price: 156000, img: 'img/kittaladroyamoladora.jpg', category: 'herramientas', description: 'Kit de herramientas que incluye un taladro inhalámbrico con velocidad ajustable y una amoladora angular  de alta potencia, ambos inhalámbricos, incluye 2 baterías más cargador rápido.', nuevo: true },
  { id: 55, title: ' Desmalezadora a explosión 52cc ', price: 126000, img: 'img/desmalezadora.jpg', category: 'herramientas', description: 'Desmalezadora a explosión 52cc, ideal para trabajos de jardinería y mantenimiento de áreas verdes.' },
  { id: 56, title: ' Zuncho Criquet de amarre de 10 mts (sin stock)', price: 17000, img: 'img/zunchocriquet.jpg', category: 'herramientas', description: 'Zuncho Criquet de amarre de 10 mts, super reforado,  ideal para amarrar y remolcar 5 toneladas.' },
  { id: 57, title: 'Set de juego de llaves de 46 piezas ', price: 24500, img: 'img/setde46pzas.jpg', category: 'herramientas', description: 'Set de juego de llaves de 46 piezas, uso profesional , ideal para trabajos de mecánica y mantenimiento.', nuevo: true },
  { id: 58,
  ...
  { id: 59, title: 'Llave criquet de 1/2 ', price: 8000, img: 'img/llavecriquet.jpg', category: 'herramientas', description: 'Llave criquet de 1/2, ideal para trabajos de mecánica y mantenimiento.' },
  { id: 60, title: 'Drone plegable 6 KHD ', price: 57000, img: 'img/drone.jpg', category: 'herramientas', description: 'Drone plegable 6 KHD, ideal para capturar imágenes aéreas y videos en alta definición, protección 360 contra golpes, ideal para principiantes, fácil de usar.', nuevo: true },
  { id: 61,
